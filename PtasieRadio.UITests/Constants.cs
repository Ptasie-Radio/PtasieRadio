namespace PtasieRadio.UITests;

public class Constants
{
    public readonly static string WebAssemblyDefaultUri = "http://localhost:5000/";
    public readonly static string iOSAppName = "com.PtasieRadio.PtasieRadio";
    public readonly static string AndroidAppName = "com.PtasieRadio.PtasieRadio";
